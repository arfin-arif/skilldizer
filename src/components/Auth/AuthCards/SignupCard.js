...
const SignUpCard = () => {
	...
	return (
		<section className="grid bg-[#FDECE4] w-full place-items-center">
			{loginCard ? (
				<LoginCard />
			) : (
				<div className="shadow-md p-10 place-items-center max-w-4xl rounded-2xl bg-[#FFFFFF] overflow-hidden">
					<motion.div
					...
					>
						<div>
							<h2 className="text-[2rem] text-[#313140] font-semibold">
								Get <span className="text-[#FF5A00]">Started</span> As Student
							</h2>
