...
const Experience = ({ index, removeExperience }) => {
		...
		<div className="bg-white py-6 px-10 mt-5">
			...
			<div className="pt-6 flex flex-col gap-8">
				<span className="flex flex-col">
					...
					<input className="mt-3 border-[#E5E7EB] placeholder:text-[#7A7A7A] text-[#7A7A7A] border-2 h-[2.5rem] pl-2 w-[374px] bg-[#f3f3f3]" />
				</span>
				...
				<div className="flex flex-col">
					...
					<span className="flex gap-12 relative">
						<select
							className="mt-3 border-[#E5E7EB] placeholder:text-[#7A7A7A] text-[#7A7A7A] border-2 h-[2.5rem] pl-2 w-[166px] bg-[#f3f3f3]"
