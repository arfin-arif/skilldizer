...
const Settings = () => {
  return (
    <div>
      <Menu>
        <Menu.Button className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
          <svg
            aria-hidden="true"
        ...
        <Menu.Items className="py-2 pl-6 text-sm font-medium text-gray-700">
          <Menu.Item>
            {({ active }) => (
              <Link
          ...
          <Menu.Item>
            {({ active }) => (
              <Link
                ...
                href="/dashboard/settings/payment_methods"
              >
                Payment Methods
              </Link>
            )}
          ...
          <Menu.Item>
            {({ active }) => (
              <Link
                ...
                href="/dashboard/settings/payment_history"
              >
                Payment History
              </Link>
            )}
